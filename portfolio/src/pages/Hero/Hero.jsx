...
const handleResumeDownload = () => {
  ...
  link.href = "/rsm.pdf";
  link.download = "Karan_Jadhav_Resume.pdf";
...
export default function Hero() {
  ...
  const [code] = useState(`const profile = {
    name: 'Karan Jadhav',
    title: 'Full-Stack Developer | Machine Learning Dev | Problem Solver',
    skills: [
        'React','TailwindCSS', 'Javascript',"Typescript",
        'Nodejs','Express', 'MongoDB', 'PostgresSQL',
        'Netlify', 'Git', 'Render', 'Vercel','PythonAnywhere','N8N',
  ...
  return (
    <>
      <main data-section="home" className="bg-[#020617] text-white p-0 md:pr-8 min-h-screen">
        <section
    ...
    <span className="typing-effect gradient-text">
      ...
      Karan Jadhav
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Machine Learning Engineer | Full Stack Developer | Building intelligent web solutions  
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/karan4065"
...
>
                  ...
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 border border-gray-700/50 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-gray-800 group-hover:to-slate-900">
              ...
              {/* Floating badges */}
              <div className="hidden lg:block absolute left-[15.5rem] top-[2.5rem] animate-float">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;Exploring
                </div>
              </div>
